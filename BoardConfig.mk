...
SHRP_LITE := true
SHRP_EXLUDE_TZDATA := true
SHRP_EXCLUDE_LPDUMP := true
SHRP_EXCLUDE_FB2PNG := true
SHRP_EXCLUDE_SUPERSU := true
SHRP_EXCLUDE_NTFS_3G := true
SHRP_EXTRA_LANGUAGES := false
SHRP_EXCLUDE_APEX := true
SHRP_EXCLUDE_NANO := true
SHRP_EXCLUDE_APEX := true
SHRP_EXCLUDE_PYTHON := true
...
# Version
TW_DEVICE_VERSION := VALE | X6815D >A12+<
